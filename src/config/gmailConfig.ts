...
export const GMAIL_CONFIG = {
   ...
   * For web-application OAuth clients Google requires the secret for token
   * exchange.  It is NOT truly secret — Google relies on redirect-URI
   * validation and PKCE for security, not the client secret.
   */
